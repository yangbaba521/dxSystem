...
<head>
    ...
    <link href="css/main/operationArea.css" rel="stylesheet" type="text/css"/>
        ...
        <ul id="home_body_guide_area" class="">
            ...
            <li id="home_body_guide_area_update">
                ...
                <ul id="home_body_guide_area_update_pages" class="">
                    <li id="home_body_guide_area_update_pages_area" class="guide_selected">
                        <span>区域维护</span>
                    </li>
...
<div id="areaInfo">
    <div id="areaInfo_title" name="title">
        <span name="line">----------</span>
        <span name="title">区域信息</span>
        <span name="line">----------</span>
    </div>
    <div id="areaInfo_info" name="info">
        <div id="areaInfo_info_areaCode" name="areaCode">
            <label for="areaInfo_info_areaCode_input">区域编号:</label>
            <input type="text" id="areaInfo_info_areaCode_input" name="areaCode" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="areaInfo_info_areaName" name="areaName">
            <label for="areaInfo_info_areaName_input">区域名称:</label>
            <input type="text" id="areaInfo_info_areaName_input" name="areaName" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="areaInfo_info_leaderCode" name="leaderCode">
            <label for="areaInfo_info_leaderCode_input">负责人工号:</label>
            <input type="text" id="areaInfo_info_leaderCode_input" name="leaderCode" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="areaInfo_info_leaderName" name="leaderName">
            <label for="areaInfo_info_leaderName_input">负责人名称:</label>
            <input type="text" id="areaInfo_info_leaderName_input" name="leaderName" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="areaInfo_info_areaTarget" name="areaTarget">
            <label for="areaInfo_info_areaTarget_input">区域目标:</label>
            <input type="text" id="areaInfo_info_areaTarget_input" name="areaTarget" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
    </div>
    <div id="areaInfo_button">
        <input type="button" id="areaInfo_button_cancel" name="cancel" value="取消"/>
        <input type="button" id="areaInfo_button_submit" name="submir" value="提交"/>
    </div>
</div>
...
<script src="js/main/operationArea.js"></script>
</body>
</html>
