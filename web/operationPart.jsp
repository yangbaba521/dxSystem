...
<head>
    ...
    <link href="css/main/operationPart.css" rel="stylesheet" type="text/css"/>
        ...
        <ul id="home_body_guide_area" class="">
            ...
            <li id="home_body_guide_area_update">
                ...
                <ul id="home_body_guide_area_update_pages" class="">
                    ...
                    <li id="home_body_guide_area_update_pages_part" class="guide_selected">
                        <span>区部维护</span>
                    </li>
            ...
            <div id="home_body_action_area_select" class="">
                <div id="home_body_action_area_select_type" name="type">
                    ...
                    <select>
                        ...
                        <option value="partCode">区部编号</option>
                        <option value="partName">区部名称</option>
                        <option value="areaCode">所属编号</option>
                        <option value="areaName">所属名称</option>
                        <option value="leaderCode">主管编号</option>
                        <option value="leaderName">主管名称</option>
                        <option value="partTarget">区部目标</option>
                    </select>
                </div>
...
<div id="partInfo">
    <div id="partInfo_title" name="title">
        <span name="line">----------</span>
        <span name="title">区部信息</span>
        <span name="line">----------</span>
    </div>
    <div id="partInfo_info" name="info">
        <div id="partInfo_info_partCode" name="partCode">
            <label for="partInfo_info_partCode_input">区部编号:</label>
            <input type="text" id="partInfo_info_partCode_input" name="partCode" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_partName" name="partName">
            <label for="partInfo_info_partName_input">区部名称:</label>
            <input type="text" id="partInfo_info_partName_input" name="partName" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_areaCode" name="areaCode">
            <label for="partInfo_info_areaCode_input">所属编号:</label>
            <input type="text" id="partInfo_info_areaCode_input" name="areaCode" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_areaName" name="areaName">
            <label for="partInfo_info_areaName_input">所属名称:</label>
            <input type="text" id="partInfo_info_areaName_input" name="areaName" disabled="true" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_leaderCode" name="leaderCode">
            <label for="partInfo_info_leaderCode_input">负责人工号:</label>
            <input type="text" id="partInfo_info_leaderCode_input" name="leaderCode" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_leaderName" name="leaderName">
            <label for="partInfo_info_leaderName_input">负责人名称:</label>
            <input type="text" id="partInfo_info_leaderName_input" name="leaderName" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
        <div id="partInfo_info_partTarget" name="partTarget">
            <label for="partInfo_info_partTarget_input">区部目标:</label>
            <input type="text" id="partInfo_info_partTarget_input" name="partTarget" class="readyInput"/>
            <img name="warning" src="img/warning.png"/>
        </div>
    </div>
    <div id="partInfo_button">
        <input type="button" id="partInfo_button_cancel" name="cancel" value="取消"/>
        <input type="button" id="partInfo_button_submit" name="submit" value="提交"/>
    </div>
</div>
...
<script src="js/main/operationPart.js"></script>
</body>
</html>
