...
import partInfoAction.getPartList;
 ...
 */
@WebServlet(name = "getTeamList")
public class getTeamList extends HttpServlet {
    Logger logger = Logger.getLogger(getTeamList.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            if(selectType.equals("teamTarget")){
            ...
            try{
                ...
                if(resNum > 0) {
                    ...
                    //分辨是否按条件查询
                    int index = 0;
                    if(selectType.equals("teamCode")){
                        index = 1;
                    }else if(selectType.equals("teamName")){
                        index = 2;
                    }else if(selectType.equals("partCode")){
                        index = 3;
                        ...
                        index = 6;
                    }else if(selectType.equals("teamTarget")){
                        index = 7;
                    }
                    if(index != 0 && index != 7){
