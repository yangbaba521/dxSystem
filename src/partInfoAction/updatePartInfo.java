...
import areaInfoAction.updateAreaInfo;
 ...
 */
@WebServlet(name = "updatePartInfo")
public class updatePartInfo extends HttpServlet {
    Logger logger = Logger.getLogger(updatePartInfo.class);
        ...
        try{
            ...
            try{
                ...
                if(resNum <= 0 || (!(result.get(0).equals("root")) && !(result.get(0).equals("charge")) )){
                    ...
                    mysqlStr="update part set partName='"+ partInfo[1] +"',areaCode='"+partInfo[2]+"',areaName='"+partInfo[3]+"',leaderCode='"+partInfo[4]+"',leaderName='"+partInfo[5]+"',target='"+partInfo[6]+"' where partCode='"+ partInfo[0] +"';";
