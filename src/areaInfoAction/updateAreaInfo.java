 ...
 */
@WebServlet(name = "updateAreaInfo")
public class updateAreaInfo extends HttpServlet {
    Logger logger = Logger.getLogger(updateAreaInfo.class);
        ...
        try{
            ...
            try{
                ...
                if(resNum <= 0 || (!(result.get(0).equals("root")) && !(result.get(0).equals("charge")) )){
                    ...
                    mysqlStr="update area set areaName='"+areaInfo[1]+"',leaderCode='"+areaInfo[2]+"',leaderName='"+areaInfo[3]+"',target='"+areaInfo[4]+"' where areaCode='"+ areaInfo[0] +"';";
